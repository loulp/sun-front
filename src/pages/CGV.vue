<template>
  <div class="container">
    ...
    <p>
      Le Site *** est édité par Typhen LE ROMANCER - SUN Jewelry,Auto-entreprise
      immatriculée sous le N°SIRET 90756792900027, ayant son siège social au 2
      rue de l’oiselière 69009 Lyon.
    </p>
    <p>L’hébergement technique du Site est assuré par la société ***</p>
    <p>Le Site a été réalisé par Louis LE POGAM AKA Loulou le fou</p>
    ...
    <p>
      ...
      par le Vendeur sur le site www.***.com. Le Vendeur a pour activité la
      vente de bijoux.
    </p>
    <p>
      ...
      des Produits, sont présentées sur le site www.***.com ce dont le client
    ...
    <p>
      Ces CGV sont accessibles à tout moment sur le site www.***.com et
    ...
    <p>
      ...
      la procédure de commande en ligne du site www.***.com.
    </p>
    <p>
    ...
    <p>e-mail : s.u.n.jewelry@hotmail.com</p>
    <p>téléphone : +33 6 27 95 56 64</p>
    <p>
      Les Produits présentés sur le site www.***.com sont proposés à la vente
    ...
    <p>
      ...
      www.***.com, lors de l’enregistrement de la commande par le Vendeur.
    </p>
    <p>
      Les tarifs tiennent compte d’éventuelles réductions qui seraient
      consenties par le Vendeur sur le site www.***.com.
    </p>
    <p>
    ...
    <p>
      Il appartient au Client de sélectionner sur le site www.***.com les
    ...
    <p>
      Toute commande passée sur le site www.***.com constitue la formation d’un
    ...
    <p>
      ...
      transactions bancaires réalisées sur le site www.***.com.
    </p>
    <p>
    ...
    <ul>
      ...
      <li>
        ...
        sur le site www.***.com grâce au système de paiement en ligne du
    ...
    <p>
      ...
      personnel, les Clients et utilisateurs du site www.***.com disposent des
      droits suivants :
    </p>
    <ul>
      <li>
    ...
    <p>
      Le contenu du site www.loyaleparis.com est la propriété du Vendeur et de
    ...
    <p>
      ...
      Client souhaite se rétracter de la commande passée sur www.***.com sauf
